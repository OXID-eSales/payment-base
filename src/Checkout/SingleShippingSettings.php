...
/**
 * Reads blPaymentBaseAutoAssignSingleShipping from OXID's ModuleSettingService
 * (the store the admin module-config form writes to — `saveShopConfVar` writes
 * a different one, and the two diverge silently).
 *
 ...
 */
class SingleShippingSettings implements SingleShippingSettingsInterface
{
    private const SETTING_NAME = 'blPaymentBaseAutoAssignSingleShipping';
